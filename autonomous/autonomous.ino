...
//  Serial1.println(PMTK_Q_RELEASE);
  ...
  Serial.print(F("MPU9250 ")); Serial.print(F("I AM ")); Serial.print(c, HEX); Serial.print(F(" I should be ")); Serial.println(0x71, HEX);
  ...
  if (c == 0x71) // WHO_AM_I should always be 0x68
  {
    ...
    Serial.print(F("AK8963 ")); Serial.print(F("I AM ")); Serial.print(d, HEX); Serial.print(F(" I should be ")); Serial.println(0x48, HEX);
...
void serialDebugMPU() {
  Serial.print(F("\nax = ")); Serial.print((int)1000 * ax);
  Serial.print(F(" ay = ")); Serial.print((int)1000 * ay);
  Serial.print(F(" az = ")); Serial.print((int)1000 * az); Serial.println(F(" mg"));
  Serial.print(F("gx = ")); Serial.print( gx, 2);
  Serial.print(F(" gy = ")); Serial.print( gy, 2);
  Serial.print(F(" gz = ")); Serial.print( gz, 2); Serial.println(F(" deg/s"));
  Serial.print(F("mx = ")); Serial.print( (int)mx );
  Serial.print(F(" my = ")); Serial.print( (int)my );
  Serial.print(F(" mz = ")); Serial.print( (int)mz ); Serial.println(F(" mG"));

  Serial.print(F("q0 = ")); Serial.print(q[0]);
  Serial.print(F(" qx = ")); Serial.print(q[1]);
  Serial.print(F(" qy = ")); Serial.print(q[2]);
  Serial.print(F(" qz = ")); Serial.println(q[3]);
...
void writeScreenGPS(double distance, double bearing) {
  ...
  display.print(GPS.hour, DEC); display.print(F(":"));
